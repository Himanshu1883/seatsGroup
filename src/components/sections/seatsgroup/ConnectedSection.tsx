          ...
          <Reveal variant="fade" delay={120} className="absolute inset-0">
            ...
            >
              ...
              <path
                ...
                strokeDasharray="2.5 5"
              />
              <circle cx="88" cy="72" r="3" fill="#c49a2c" />
              <circle cx="84" cy="206" r="3" fill="#c49a2c" />
              <circle cx="556" cy="84" r="3" fill="#c49a2c" />
              <circle cx="552" cy="220" r="3" fill="#c49a2c" />
              <circle cx="286" cy="148" r="3" fill="#c49a2c" />
              <circle cx="300" cy="168" r="3" fill="#c49a2c" />
              <circle cx="350" cy="154" r="3" fill="#c49a2c" />
              <circle cx="352" cy="176" r="3" fill="#c49a2c" />
            </svg>
          </Reveal>
